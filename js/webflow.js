...
Webflow.require('ix').init([
  ...
  {"slug":"nav-bar-fixed-on-scroll","name":"Nav Bar Fixed on Scroll","value":{"style":{},"triggers":[{"type":"scroll","stepsA":[],"stepsB":[{"opacity":1,"transition":"opacity 500ms ease 0ms"}]}]}},
  ...
  {"slug":"move-down-hero-header","name":"Move Down Hero Header ","value":{"style":{"opacity":0,"x":"0px","y":"-15px","z":"0px"},"triggers":[{"type":"load","stepsA":[{"opacity":1,"wait":200,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","x":"0px","y":"0px","z":"0px"}],"stepsB":[]}]}},
  ...
  {"slug":"show-up-body","name":"Show Up Body","value":{"style":{"opacity":0},"triggers":[{"type":"load","stepsA":[{"opacity":1,"wait":200,"transition":"opacity 500ms ease 0ms"}],"stepsB":[]}]}},
  {"slug":"show-up-on-scroll-1","name":"Show Up On Scroll 1 ","value":{"style":{"opacity":0},"triggers":[{"type":"scroll","offsetBot":"30%","stepsA":[{"opacity":1,"transition":"opacity 500ms ease 0ms"}],"stepsB":[]},{"type":"scroll","selector":".feature-icon","stepsA":[{"opacity":1,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","x":"0px","y":"0px","z":"0px"}],"stepsB":[]},{"type":"hover","selector":".multicolumn-hover","descend":true,"stepsA":[{"opacity":1,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","x":"0px","y":"0px","z":"0px"}],"stepsB":[{"opacity":0,"transition":"opacity 500ms ease 0ms"}]}]}},
  ...
  {"slug":"initial-appearance-multicolumn-hover","name":"Initial Appearance Multicolumn Hover","value":{"style":{"opacity":0},"triggers":[{"type":"hover","stepsA":[{"opacity":1,"transition":"opacity 500ms ease 0ms"}],"stepsB":[{"opacity":0,"transition":"opacity 500ms ease 0ms"}]}]}},
  ...
  {"slug":"initial-appearance-hero-image","name":"Initial Appearance Hero Image","value":{"style":{"opacity":0},"triggers":[{"type":"load","preload":true,"stepsA":[{"opacity":1,"transition":"opacity 500ms ease 0ms"}],"stepsB":[]}]}},
  {"slug":"open-lightbox","name":"Open Lightbox","value":{"style":{},"triggers":[{"type":"click","selector":".lightbox","siblings":true,"stepsA":[{"title":"Display Custom Lightbox","display":"block"},{"opacity":1,"transition":"opacity 500ms ease 0ms"}],"stepsB":[]}]}},
  {"slug":"close-lightbox","name":"Close Lightbox","value":{"style":{},"triggers":[{"type":"click","selector":".lightbox","stepsA":[{"opacity":0,"transition":"opacity 500ms ease 0ms"},{"title":"Close Custom Lightbox","display":"none"}],"stepsB":[]}]}},
  {"slug":"close-lightbox-2","name":"Close Lightbox 2","value":{"style":{},"triggers":[{"type":"click","selector":".lightbox","stepsA":[{"opacity":0,"transition":"opacity 500ms ease 0ms"},{"title":"Close Custom Lightbox","display":"none"}],"stepsB":[]}]}}
]);
